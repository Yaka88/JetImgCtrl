========================================================================
		ActiveX Control DLL : JETIMGCTRL
========================================================================

ControlWizard has created this project for your JETIMGCTRL ActiveX Control
...
that make up your JETIMGCTRL ActiveX Control DLL.
...
JetImgCtrlCtl.h
	This file contains the declaration of the CJetImgCtrlCtrl C++ class.

JetImgCtrlCtl.cpp
	This file contains the implementation of the CJetImgCtrlCtrl C++ class.

JetImgCtrlPpg.h
	This file contains the declaration of the CJetImgCtrlPropPage C++ class.

JetImgCtrlPpg.cpp
	This file contains the implementation of the CJetImgCtrlPropPage C++ class.

JetImgCtrlCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CJetImgCtrlCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file JetImgCtrl.rc.
